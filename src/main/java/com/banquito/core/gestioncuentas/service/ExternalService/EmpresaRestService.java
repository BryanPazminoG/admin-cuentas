...
public class EmpresaRestService {
    ...
    public ResponseEntity<String> obtenerPorId(String id) {
        String url = UriComponentsBuilder.fromHttpUrl("http://34.123.168.16:8080/api/v1/clientes/empresas")
                .pathSegment(id)
                .build()
                .toString();
        ResponseEntity<String> response = restTemplate.getForEntity(url, String.class);
    ...
    public ResponseEntity<String> obtenerPorIdentificacion(String numeroIdentificacion) {
        String url = UriComponentsBuilder.fromHttpUrl("http://34.123.168.16:8080/api/v1/clientes/empresas/identificacion")
